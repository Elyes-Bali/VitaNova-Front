...
export class StatsComponent implements OnInit {
  ...
  constructor(
    ...
    private consultationService: PsychologueService,
  ...
  ngOnInit(): void {
    ...
    this.route.params.pipe(takeUntil(this.destroy$)).subscribe(params => {
      this.psychologueId = +params['psychologueId']; // Convert to number if needed
  ...
  getConsultations(): void {
    this.consultationService
      .getConsultations(this.psychologueId, this.selectedYear, this.selectedMonth)
      .subscribe(response => {
